...
use parquet::{arrow::async_writer::{AsyncArrowWriter, ParquetObjectWriter}, file::properties::WriterProperties};
...
async fn main() {
    ...
    let store = Arc::new(LocalFileSystem::new_with_prefix("/Users/albertlockett/Desktop/parquet_files").unwrap());
